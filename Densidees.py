#!/usr/sfw/bin/python
# -*- coding: utf-8 -*-
#C:\Python38\python.exe C:\These\2009Densidees\densidees\Densidees.py C:\These\2009Densidees\densidees\treetagger_output.tsv
...
if os.path.isfile(thefile):
        ...
        output = open(thefile+".di.txt", "w", encoding="utf-8")
        ...
        if visible==1:
                ...
                print("Densité des idées : " + str(round(10*(nbProps+0.00000001)/(nbWords+0.00000001),4)))
        ...
        for item in numRegles:
                ...
                if visible==1:
                        print (str(bilanRegles[item])+" fois la règle "+item)
        output.close()
else:
        if thefile=="help":
